...
namespace Payment
{
    public partial class dialogPurchaseForm : Syncfusion.Windows.Forms.MetroForm
    {
        ...
        public dialogPurchaseForm(string username, string typeForm, string id)
        {
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            if (cmbFilterColumn.SelectedItem.ToString() == "No. Invoice")
            {
        ...
        public void Grid_Load(string code = "", string relationCode = "", string relationName = "")
        {
            try
            {
                String sqlString = "SELECT id, code, relationCode, relationName, total, (total-paid) as remaining " +
                ...
                gridView.Columns[2].HeaderText = "Kode Mitra";
                gridView.Columns[3].HeaderText = "Nama Mitra";
                gridView.Columns[4].HeaderText = "Jumlah Invoice";
                gridView.Columns[5].HeaderText = "Sisa Invoice";
            }
            catch (Exception ex)
            {
        ...
        {
            cmbFilterColumn.Items.Add("No. Invoice");
            cmbFilterColumn.Items.Add("Kode Mitra");
            cmbFilterColumn.Items.Add("Nama Mitra");
            cmbFilterColumn.SelectedItem = "No. Invoice";
        }
        #endregion
