...
namespace Purchase
{
    public partial class rptPurchaseForm : Syncfusion.Windows.Forms.MetroForm
    {
        string connString = ConfigurationManager.ConnectionStrings["stowageConnection"].ToString();
        string id = "";
        string reportName = "rptPurchase.rpt";

        public rptPurchaseForm(string id)
        {
            this.id = id;
            InitializeComponent();
        }

        private void rptPurchaseForm_Load(object sender, EventArgs e)
        {
