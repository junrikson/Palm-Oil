...
namespace Receipt
{
    public partial class rptReceiptForm : Syncfusion.Windows.Forms.MetroForm
    {
        string connString = ConfigurationManager.ConnectionStrings["stowageConnection"].ToString();
        string id = "";
        string reportName = "rptReceipt.rpt";

        public rptReceiptForm(string id)
        {
            this.id = id;
            InitializeComponent();
        }

        private void rptReceiptForm_Load(object sender, EventArgs e)
        {
