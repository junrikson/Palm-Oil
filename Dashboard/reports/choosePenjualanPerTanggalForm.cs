...
namespace Dashboard
{
    public partial class choosePenjualanPerTanggalForm : Syncfusion.Windows.Forms.MetroForm
    {
        string connString = ConfigurationManager.ConnectionStrings["stowageConnection"].ToString();
        string id = "";
        string reportName = "rptPenjualanPerTanggal.rpt";

        public choosePenjualanPerTanggalForm()
        {
            InitializeComponent();
        }

        private void choosePenjualanPerTanggalForm_Load(object sender, EventArgs e)
        {
