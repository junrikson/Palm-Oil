...
namespace Dashboard
{
    public partial class choosePembelianPerTanggalForm : Syncfusion.Windows.Forms.MetroForm
    {
        string connString = ConfigurationManager.ConnectionStrings["stowageConnection"].ToString();
        string id = "";
        string reportName = "rptPembelianPerTanggal.rpt";

        public choosePembelianPerTanggalForm()
        {
            InitializeComponent();
        }

        private void choosePembelianPerTanggalForm_Load(object sender, EventArgs e)
        {
