...
namespace Dashboard
{
    public partial class choosePembayaranPerTanggalForm : Syncfusion.Windows.Forms.MetroForm
    {
        string connString = ConfigurationManager.ConnectionStrings["stowageConnection"].ToString();
        string id = "";
        string reportName = "rptPembayaranPerTanggal.rpt";

        public choosePembayaranPerTanggalForm()
        {
            InitializeComponent();
        }

        private void choosePembayaranPerTanggalForm_Load(object sender, EventArgs e)
        {
