...
namespace Dashboard
{
    public partial class choosePelunasanPerTanggalForm : Syncfusion.Windows.Forms.MetroForm
    {
        string connString = ConfigurationManager.ConnectionStrings["stowageConnection"].ToString();
        string id = "";
        string reportName = "rptPelunasanPerTanggal.rpt";

        public choosePelunasanPerTanggalForm()
        {
            InitializeComponent();
        }

        private void choosePelunasanPerTanggalForm_Load(object sender, EventArgs e)
        {
