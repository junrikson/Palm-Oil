...
namespace MasterMill
{
    public partial class EditForm : Syncfusion.Windows.Forms.MetroForm 
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            if (isValid())
            {
                try
                {
                    ...
                    {
                        using (SqlCommand cmd = new SqlCommand("UPDATE masterMill " +
                            "SET name = @name, " +
                            "address = @address, " +
                            "phone = @phone, " +
                            "handphone = @handphone, " +
        ...
        private Boolean isValid()
        {
            ...
            {
                isValidated = false;
                MessageBox.Show("Kode Pabrik harus diisi!", "Warning!", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                txtCode.Focus();
            }
            else if (String.IsNullOrEmpty(txtName.Text))
            {
                isValidated = false;
                MessageBox.Show("Nama Pabrik harus diisi!", "Warning!", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                txtName.Select();
            }
